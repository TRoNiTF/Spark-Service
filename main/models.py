...
class CustomUserManager(BaseUserManager):
    def create_user(self, telephone, email=None, password=None, **extra_fields):
        if not telephone:
...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    telephone = models.CharField('Телефон', max_length=18, unique=True, validators=[telephone_validator])
...
class Service(models.Model):
    name = models.CharField('Название услуги', max_length=24)
